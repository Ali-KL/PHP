...
$phonerate = $phones[0]['rate'];
$starate = '<i class="fa-solid fa-star"></i>';
?>
...
<head>
  ...
  <!-- <link rel="stylesheet" href="/orange-php/css/style.css" /> -->
...
<body>
  ...
  ?>
    <div class="container container-fluid d-grid col-3">
      <div class="card" style="width: 18rem; padding:5px; margin:5px;  ">
        <img style="height: 250px;" src="<?php echo $phones[$i]['img_url'] ?>" class="card-img-top" alt="...">
        <div class="card-body">
          <h6 class="card-subtitle mb-2 text-muted"><?php echo $phones[$i]['brand'] ?></h6>
          <h6 class="card-rating mb-2 text-muted"><?php for ($star = 0; $star < $phonerate; $star++) {
                                                    echo $starate;
                                                  } ?></h6>
          <h5 class="card-title"><?php echo $phones[$i]['name'] ?></h5>
          <p style="font-weight:bold ; color: #FF7600; border-top:2px solid gray;" class="card-text"><?php echo $phones[$i]['price'] ?></p>
